 ...
 */
final class Version20250309104013 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE acl_plan (name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, price NUMERIC(8, 2) NOT NULL, trial BOOLEAN NOT NULL, active BOOLEAN NOT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE acl_plan_features (name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, plan_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE acl_plan_roles (created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, plan_id VARCHAR(26) DEFAULT NULL, role_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE acl_role (name VARCHAR(255) NOT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7065EB795E237E06 ON acl_role (name)');
        $this->addSql('CREATE TABLE boards_board (name VARCHAR(300) NOT NULL, members_count SMALLINT NOT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, workspace_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_766DD09482D40A1F ON boards_board (workspace_id)');
        $this->addSql('CREATE TABLE boards_board_channel (created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, board_id VARCHAR(26) DEFAULT NULL, channel_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE boards_board_steps (name VARCHAR(255) NOT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, board_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2828F6DEE7EC5785 ON boards_board_steps (board_id)');
        $this->addSql('CREATE TABLE boards_shared_boards (name VARCHAR(300) NOT NULL, members_count SMALLINT NOT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, board_id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6EB136F0E7EC5785 ON boards_shared_boards (board_id)');
        $this->addSql('CREATE TABLE channels_channel (name VARCHAR(250) NOT NULL, total_connected SMALLINT NOT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, workspace_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C5C46D2482D40A1F ON channels_channel (workspace_id)');
        $this->addSql('CREATE TABLE channels_shared_channel_workspaces (created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, shared_channel_id VARCHAR(26) NOT NULL, target_workspace_id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE channels_shared_channels (name VARCHAR(190) NOT NULL, description VARCHAR(500) DEFAULT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, channel_id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_59EAB76972F5A1AA ON channels_shared_channels (channel_id)');
        $this->addSql('CREATE TABLE messages_message (body JSON NOT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, channel_id VARCHAR(26) DEFAULT NULL, author_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE messages_message_reaction (reaction VARCHAR(50) NOT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, reactor_id VARCHAR(26) DEFAULT NULL, message_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE users_refresh_token (refresh_token VARCHAR(128) NOT NULL, username VARCHAR(255) NOT NULL, valid TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, scopes JSON DEFAULT \'[]\', created_at DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CEAA2998C74F2195 ON users_refresh_token (refresh_token)');
        $this->addSql('CREATE TABLE users_user (email VARCHAR(191) NOT NULL, phone VARCHAR(19) DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, current_workspace_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE users_user_profiles (full_name VARCHAR(190) NOT NULL, photo VARCHAR(255) DEFAULT NULL, timezone TIMESTAMP(0) WITH TIME ZONE NOT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, user_id VARCHAR(26) DEFAULT NULL, workspace_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE workspaces_worker (created_at DATE NOT NULL, id VARCHAR(26) NOT NULL, workspace_id VARCHAR(26) DEFAULT NULL, user_id VARCHAR(26) DEFAULT NULL, role_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
