 ...
 */
final class Version20250308085328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE acl_plan (name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, price NUMERIC(8, 2) NOT NULL, trial BOOLEAN NOT NULL, active BOOLEAN NOT NULL, id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE acl_plan_features (name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, id VARCHAR(26) NOT NULL, plan_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE acl_plan_roles (id VARCHAR(26) NOT NULL, plan_id VARCHAR(26) DEFAULT NULL, role_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE acl_role (name VARCHAR(255) NOT NULL, id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7065EB795E237E06 ON acl_role (name)');
        $this->addSql('CREATE TABLE channels_channel (name VARCHAR(250) NOT NULL, total_connected SMALLINT NOT NULL, id VARCHAR(26) NOT NULL, workspace_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C5C46D2482D40A1F ON channels_channel (workspace_id)');
        $this->addSql('CREATE TABLE channels_shared_channel_workspaces (id VARCHAR(26) NOT NULL, shared_channel_id VARCHAR(26) NOT NULL, target_workspace_id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE channels_shared_channels (name VARCHAR(190) NOT NULL, description VARCHAR(500) DEFAULT NULL, id VARCHAR(26) NOT NULL, channel_id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE users_user (email VARCHAR(191) NOT NULL, phone VARCHAR(19) DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_421A9847E7927C74 ON users_user (email)');
        $this->addSql('CREATE TABLE users_user_profiles (full_name VARCHAR(190) NOT NULL, photo VARCHAR(255) DEFAULT NULL, timezone TIMESTAMP(0) WITH TIME ZONE NOT NULL, id VARCHAR(26) NOT NULL, user_id VARCHAR(26) DEFAULT NULL, workspace_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE workspaces_worker (id VARCHAR(26) NOT NULL, workspace_id VARCHAR(26) DEFAULT NULL, user_id VARCHAR(26) DEFAULT NULL, role_id VARCHAR(26) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE workspaces_workspace (name VARCHAR(300) NOT NULL, members_count SMALLINT NOT NULL, id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
