 ...
 */
final class Version20250312104221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE workspaces_workspace (name VARCHAR(300) NOT NULL, members_count SMALLINT NOT NULL, url_path VARCHAR(500) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, id VARCHAR(26) NOT NULL, PRIMARY KEY(id))');
